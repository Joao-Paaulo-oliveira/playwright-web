...
- `automacao/data/login-cases.json`: armazena os dados dos casos de teste, como usuário, senha e cenários esperados.
...
- Os valores são usados pelo utilitário de substituição de variáveis em `automacao/utils/test-data.js`.
...
- Centralização dos dados em arquivo JSON
